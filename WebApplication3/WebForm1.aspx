                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-12">
                                    <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                        <h4 class="mb-3">Good <span>Design</span>
                                            <br>
                                        ...
                                        <div class="mt-2 mt-lg-auto">
                                            <a href="about.html" class="custom-link mb-2">Learn more about us
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-12">
                                    <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                        ...
                                        <div class="mt-2 mt-lg-auto">
                                            <a href="contact.html" class="custom-link mb-2">Work with us
                                                        <i class="bi-arrow-right ms-2"></i>
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-12">
                                    <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                        ...
                                        <div class="mt-2 mt-lg-auto">
                                            <a href="products.html" class="custom-link mb-2">Explore products
                                                        <i class="bi-arrow-right ms-2"></i>
                                            </a>
                                        </div>
                                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-12">
                    <div class="px-5 py-5 py-lg-0">
                        ...
                        <a href="products.html" class="custom-link">Explore Products
                                    <i class="bi-arrow-right ms-2"></i>
                        </a>
                    </div>
                </div>
